...
export function EnhancedLoginForm({
  ...
  const isSubmitting =
    isPending || isNavigating || optimisticState.status === "loading";
    ...
    <div className="min-h-screen flex items-center justify-center bg-linear-to-br from-gray-100 to-gray-200 p-4">
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          <div
            className={`inline-flex items-center justify-center h-16 w-16 rounded-full bg-linear-to-br ${getRoleColor()} text-white mb-4 shadow-lg transform transition-transform hover:scale-105`}
          >
            {getRoleIcon()}
          </div>
              ...
              <button
                ...
                className={`w-full py-2.5 px-4 rounded-lg font-medium text-white transition-all flex items-center justify-center gap-2 ${
                  isSubmitting
                    ...
                    : `bg-linear-to-r ${getRoleColor()} hover:opacity-90 hover:shadow-md`
                } disabled:opacity-50`}
              >
                {isSubmitting ? (
                  <>
