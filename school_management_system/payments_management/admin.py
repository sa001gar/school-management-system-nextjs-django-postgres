...
class FeeStructureAdmin(admin.ModelAdmin):
    list_display = ('name', 'class_ref', 'session', 'total_fee', 'is_active')
    list_filter = ('class_ref', 'session', 'is_active')
    search_fields = ('name',)
...
class StudentFeeAdmin(admin.ModelAdmin):
    list_display = ('student', 'fee_structure', 'net_amount', 'paid_amount', 'status')
...
class PaymentAdmin(admin.ModelAdmin):
    list_display = ('receipt_number', 'student_fee', 'amount', 'payment_method', 'payment_date')
...
class PaymentReminderAdmin(admin.ModelAdmin):
    list_display = ('student_fee', 'reminder_date', 'status')
